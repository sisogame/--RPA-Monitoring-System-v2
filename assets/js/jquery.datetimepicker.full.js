 ...
 */ !(function (t, e) {
  ...
  return (
    (e = {
      ...
      lpad: function (t, n, r) {
        var a = t.toString();
        return (r = r || "0"), a.length < n ? e.lpad(r + a, n) : a;
      },
      merge: function (t) {
        var n, r;
        for (t = t || {}, n = 1; n < arguments.length; n++)
          if ((r = arguments[n]))
            for (var a in r)
              r.hasOwnProperty(a) &&
                ("object" == typeof r[a] ? e.merge(t[a], r[a]) : (t[a] = r[a]));
        return t;
      },
    ...
    (t.prototype = {
      ...
      getMonth: function (t) {
        var n,
          r = this;
        return (
          (n = e.getIndex(t, r.dateSettings.monthsShort) + 1),
      ...
      parseDate: function (t, n) {
        ...
        if ("U" === n) return (u = e.getInt(t)), u ? new Date(1e3 * u) : t;
        switch (typeof t) {
          case "number":
            return new Date(t);
          case "string":
        ...
        if (((r = n.match(g.validParts)), !r || 0 === r.length))
          throw new Error("Invalid date format definition.");
        for (u = r.length - 1; u >= 0; u--) "S" === r[u] && r.splice(u, 1);
        for (
          a = t.replace(g.separators, "\x00").split("\x00"), u = 0;
          u < a.length;
          u++
        )
          switch (((i = a[u]), (o = e.getInt(i)), r[u])) {
            case "y":
            case "Y":
              if (!o) return null;
              (l = i.length),
            ...
            case "F":
              if (isNaN(o)) {
                if (((s = g.getMonth(i)), !(s > 0))) return null;
                y.month = s;
              } else {
            ...
            case "h":
              if (
                ...
                (f = e.compare(d, p.meridiem[0])
                  ? 0
                  : e.compare(d, p.meridiem[1])
                  ? 12
                  : -1),
                  o >= 1 && 12 >= o && -1 !== f
                    ? (y.hour = o % 12 === 0 ? f : o + f)
      ...
      guessDate: function (t, n) {
        ...
        var r,
          ...
          s,
          c = this,
          f = t.replace(c.separators, "\x00").split("\x00"),
          l = /^[djmn]/g,
          d = n.match(c.validParts),
          g = new Date(),
          h = 0;
        if (!l.test(d[0])) return t;
        for (u = 0; u < f.length; u++) {
          if (((h = 2), (o = f[u]), (s = e.getInt(o.substr(0, 2))), isNaN(s)))
            return null;
          switch (u) {
            case 0:
            ...
            case 2:
              if (
                ...
                (h = 4 > r ? r : 4),
                (a = e.getInt(
                  4 > r ? a.toString().substr(0, 4 - r) + o : o.substr(0, 4)
                )),
                !a)
              )
                return null;
          ...
          (i = o.substr(h)), i.length > 0 && f.splice(u + 1, 0, i);
        }
        return g;
      },
        ...
        return (
          (r = {
            ...
            O: function () {
              ...
              return (
                (t > 0 ? "-" : "+") +
                e.lpad(100 * Math.floor(r / 60) + (r % 60), 4)
              );
            },
            P: function () {
              var t = r.O();
            ...
            T: function () {
              var t = (String(n).match(a.tzParts) || [""])
                .pop()
                .replace(a.tzClip, "");
              return t || "UTC";
            },
      ...
      formatDate: function (t, n) {
        var r,
          ...
          c = "",
          f = "\\";
        if ("string" == typeof t && ((t = s.parseDate(t, n)), !t)) return null;
        if (t instanceof Date) {
          for (u = n.length, r = 0; u > r; r++)
            (o = n.charAt(r)),
              "S" !== o &&
                o !== f &&
                (r > 0 && n.charAt(r - 1) === f
            ...
            function (event, percentage, noTriggerScroll) {
              ...
              if (percent > 1) {
                ...
                if (noTriggerScroll !== true) {
                  timeboxparent.trigger("scroll_element.xdsoft_scroller", [
                    percentage || timeboxTop / (height - parentHeight),
                  ]);
                }
              }
            }
  ...
  $.fn.datetimepicker = function (opt, opt2) {
    ...
    createDateTimePicker = function (input) {
      ...
      datetimepicker.setOptions = function (_options) {
        ...
        if (
          _options.allowDates &&
          Array.isArray(_options.allowDates) &&
        ...
        if (
          ...
          Array.isArray(_options.highlightedDates) &&
        ...
        if (
          ...
          Array.isArray(_options.highlightedPeriods) &&
        ...
        if (
          ...
          Array.isArray(_options.disabledWeekDays) &&
        ...
        if (options.validateOnBlur) {
          input.off("blur.xdsoft").on("blur.xdsoft", function () {
            if (
              options.allowBlank &&
              (!$(this).val().trim().length ||
                (typeof options.mask === "string" &&
                  $(this).val().trim() === options.mask.replace(/[0-9]/g, "_")))
            ) {
              $(this).val(null);
      ...
      XDSoft_datetime = function () {
        ...
        _this.getWeekOfYear = function (datetime) {
          if (
            ...
            typeof options.onGetWeekOfYear === "function"
          ) {
        ...
        .on("xchange.xdsoft", function (event) {
          ...
          xchangeTimer = setTimeout(function () {
            if (
              _xdsoft_datetime.currentTime === undefined ||
              _xdsoft_datetime.currentTime === null ||
              isNaN(_xdsoft_datetime.currentTime.getTime())
            ) {
              _xdsoft_datetime.currentTime = _xdsoft_datetime.now();
            }
            ...
            while (
              ...
              if (
                ...
                typeof options.beforeShowDay.call === "function"
              ) {
      ...
      calendar.on("touchend click.xdsoft", "td", function (xdevent) {
        ...
        if (
          ...
          typeof options.onSelectDate === "function"
        ) {
        ...
        .on("touchend click.xdsoft", "div", function (xdevent) {
          if (!this.touchMoved) {
            ...
            if (
              ...
              typeof options.onSelectTime === "function"
            ) {
      ...
      datetimepicker
        .on("changedatetime.xdsoft", function (event) {
          if (
            ...
            typeof options.onChangeDateTime === "function"
          ) {
          ...
          input.on("keydown.xdsoft", function (event) {
            ...
            if (
              ...
              while (true) {
                ...
                var curPosOnSep =
                  notNumberOrPlaceholder.test(maskValueAtCurPos);
              ...
              if (hasSel) {
                ...
                var selReplacementRemainder =
                  defaultBlankSelectionReplacement.substr(1); // might be empty
        ...
        if (typeof opt === "string") {
          switch (opt) {
            ...
            default:
              if (
                datetimepicker[opt] &&
                typeof datetimepicker[opt] === "function"
              ) {

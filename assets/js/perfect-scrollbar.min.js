...
! function (t, e) {
    ...
    function h(t, e, i, n) {
        ...
        t.reach[s] = null,
            e <= 0 && (e = 0,
                t.reach[s] = "start"),
            e >= t[r] - t[l] && ((e = t[r] - t[l]) - d[o] <= 2 && (p = !0),
                t.reach[s] = "end");
        var f = d[o] - e;
        f && (d.dispatchEvent(c("ps-scroll-" + s)),
            f > 0 ? d.dispatchEvent(c("ps-scroll-" + h)) : d.dispatchEvent(c("ps-scroll-" + u)),
            p || (d[o] = e),
            t.reach[s] && d.dispatchEvent(c("ps-" + s + "-reach-" + t.reach[s])),
            n && a(t, s))
    }
    ...
    var y = function (t, e, i, n) {
        ...
        L = function (t) {
            ...
            t.containerWidth = e.clientWidth,
                ...
                e.contains(t.scrollbarXRail) || (l(e, m.element.rail("x")).forEach(function (t) {
                        return r(t)
                    }),
                    e.appendChild(t.scrollbarXRail)),
                e.contains(t.scrollbarYRail) || (l(e, m.element.rail("y")).forEach(function (t) {
                        return r(t)
                    }),
        ...
        H = {
            "click-rail": function (t) {
                ...
                t.event.bind(t.scrollbarY, "mousedown", function (t) {
                    ...
                    t.event.bind(t.scrollbarYRail, "mousedown", function (i) {
                        ...
                        y(t, "top", e.scrollTop + n * t.containerHeight),
                            L(t),
                            i.stopPropagation()
                    }),
                    ...
                    t.event.bind(t.scrollbarXRail, "mousedown", function (i) {
                        ...
                        y(t, "left", e.scrollLeft + n * t.containerWidth),
                            L(t),
                            i.stopPropagation()
                    })
            },
            "drag-thumb": function (t) {
                g(t, ["containerWidth", "contentWidth", "pageX", "railXWidth", "scrollbarX", "scrollbarXWidth", "scrollLeft", "left", "x"]),
                    g(t, ["containerHeight", "contentHeight", "pageY", "railYHeight", "scrollbarY", "scrollbarYHeight", "scrollTop", "top", "y"])
            },
            keyboard: function (t) {
                function e(e, n) {
                    var r = i.scrollTop;
                    ...
                    if (0 === n) {
                        if (!t.scrollbarXActive)
                            return !1;
                        if (0 === l && e < 0 || l >= t.contentWidth - t.containerWidth && e > 0)
                            return !t.settings.wheelPropagation
                    }
                    return !0
                }
                ...
                t.event.bind(t.ownerDocument, "keydown", function (n) {
                    if (!(n.isDefaultPrevented && n.isDefaultPrevented() || n.defaultPrevented) && (r() || l())) {
                        ...
                        t.settings.suppressScrollX && 0 !== s || t.settings.suppressScrollY && 0 !== a || (y(t, "top", i.scrollTop - a),
                            y(t, "left", i.scrollLeft + s),
                            L(t),
                            e(s, a) && n.preventDefault())
                    }
                })
            },
            wheel: function (e) {
                ...
                function r(e, i, n) {
                    if (!R.isWebKit && o.querySelector("select:focus"))
                        return !0;
                    if (!o.contains(e))
                        return !1;
                    for (var r = e; r && r !== o;) {
                ...
                function l(t) {
                    ...
                    if (!r(t.target, s, a)) {
                        var c = !1;
                        e.settings.useBothWheelAxes ? e.scrollbarYActive && !e.scrollbarXActive ? (a ? y(e, "top", o.scrollTop - a * e.settings.wheelSpeed) : y(e, "top", o.scrollTop + s * e.settings.wheelSpeed),
                                c = !0) : e.scrollbarXActive && !e.scrollbarYActive && (s ? y(e, "left", o.scrollLeft + s * e.settings.wheelSpeed) : y(e, "left", o.scrollLeft - a * e.settings.wheelSpeed),
                                c = !0) : (y(e, "top", o.scrollTop - a * e.settings.wheelSpeed),
                                y(e, "left", o.scrollLeft + s * e.settings.wheelSpeed)),
                            L(e),
                            (c = c || i(s, a)) && (t.stopPropagation(),
                                t.preventDefault())
                    }
                }
                var o = e.element;
            ...
            touch: function (t) {
                function e(e, i) {
                    ...
                    } else if (l > o && (e < 0 && r === t.contentWidth - t.containerWidth || e > 0 && 0 === r))
                        return {
                            stop: !t.settings.swipePropagation,
                            prevent: !0
                        };
                ...
                function i(e, i) {
                    y(t, "top", h.scrollTop - i),
                        y(t, "left", h.scrollLeft - e),
                        L(t)
                }
                ...
                function a(n) {
                    if (!g && t.settings.swipePropagation && s(n),
                        !b && g && o(n)) {
                        var r = l(n),
                            a = {
                                pageX: r.pageX,
                ...
                if (R.supportsTouch || R.supportsIePointer) {
                    var h = t.element,
                        ...
                        b = !1,
                        g = !1;
                    R.supportsTouch ? (t.event.bind(window, "touchstart", n),
                        t.event.bind(window, "touchend", r),
                        t.event.bind(h, "touchstart", s),
                        t.event.bind(h, "touchmove", a),
                        t.event.bind(h, "touchend", c)) : R.supportsIePointer && (window.PointerEvent ? (t.event.bind(window, "pointerdown", n),
                        t.event.bind(window, "pointerup", r),
                        t.event.bind(h, "pointerdown", s),
                        t.event.bind(h, "pointermove", a),
                        t.event.bind(h, "pointerup", c)) : window.MSPointerEvent && (t.event.bind(window, "MSPointerDown", n),
                        t.event.bind(window, "MSPointerUp", r),
                        t.event.bind(h, "MSPointerDown", s),
                        t.event.bind(h, "MSPointerMove", a),
                        t.event.bind(h, "MSPointerUp", c)))
                }
            }
        },
        T = function (n, r) {
    ...
    return E.isInitialized.get = function () {
        ...
        T.prototype.destroy = function () {
            this.isInitialized && (this.event.unbindAll(),
                r(this.scrollbarX),
                r(this.scrollbarY),
